...
public class VibraphoneSynth : MonoBehaviour
{
    ...
    void RandomizeOscillatorParameters()
    {
        ...
        osc2FrequencyRatio = new float[] {
            Random.Range(0.495f, 0.505f),
            Random.Range(0.96f, 1.05f),
            Random.Range(1.48f, 1.52f),
            Random.Range(1.96f, 2.05f)
        }[Random.Range(0, 4)];

        osc3FrequencyRatio = new float[] {
            Random.Range(0.495f, 0.505f),
            Random.Range(0.986f, 1.05f),
            Random.Range(1.492f, 1.52f),
            Random.Range(1.986f, 2.05f)
        }[Random.Range(0, 4)];
    ...
    {
        attackTime = Random.Range(0.005f, 0.05f);
